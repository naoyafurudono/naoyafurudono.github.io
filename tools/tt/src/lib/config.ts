...
export const articleDirectoryPaths: string[] = process.env.ARTICLE_DIRECTORY_PATHS?.split(",") || [
...
export const siteTitle: string = process.env.SITE_TITLE || "diary.nfurudono.com";
export const showDateOnTopPage = parseBoolean(process.env.SHOW_DATE_ON_TOP_PAGE || "false");
